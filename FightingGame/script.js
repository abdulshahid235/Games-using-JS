...
const updateGame = (p1, p2, gameState) => {
  ...
  // console.log(`in updateGame p1 name is ${p1.name} and p2 name is ${p2.name}`);
  ...
  if (p1.health <= 0 || p2.health <= 0) {
    ...
    // let msg = game.declareWinner(gameState, p1, p2);
...
let player1 = new Player("Shahid", 100, 10);
let player2 = new Player("Yasmeen", 100, 10);
...
let simbtn = document.getElementById("play");
